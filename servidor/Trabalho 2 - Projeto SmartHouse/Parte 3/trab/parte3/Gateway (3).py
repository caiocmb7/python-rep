...
def clientThreadTCP(client):
    ...
    while True:
        try:
            print("Digite o dispostivo que voce quer mandar o comando: ")
            msg = input()
            device_exists = 0
            for device in devicesTCP:
                if (msg == device):
                    device_exists = 1
            if(device_exists != 0):
                print("Digite o comando que voce quer enviar")
                comando = input()
